...
public class InternshipPositionServiceImpl implements InternshipPositionService {
    ...
    @Override
    @Transactional
    public List<InternshipPositionDashboardDto> getAllByCompanyIdMappedToDashboardDto(Long companyId) {
        return internshipPositionRepository.findAllByCompanyId(companyId)
                .stream()
                .map(InternshipPositionDashboardDto::new)
                .toList();
    }
    ...
    @Override
    public List<InternshipPosition> getAll() {
        return internshipPositionRepository.findAll();
    }
}