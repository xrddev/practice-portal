...
public class InterestsAndSkillsMatching implements InternshipAssigmentStrategy {
    ...
    public List<InternshipAssignment> match(List<Student> students, List<InternshipPosition> internshipPositions) {
        ...
        for(Student student : students){
            InternshipPosition firstBestMatch = findFirstBestMatch(student, internshipPositions);
            if(firstBestMatch != null){
                internshipPositions.remove(firstBestMatch);
                InternshipAssignment assignment = new InternshipAssignment();
                assignment.setPosition(firstBestMatch);
    ...
    private InternshipPosition findFirstBestMatch(Student student, List<InternshipPosition> positions) {
