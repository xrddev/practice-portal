...
public class MapDrivenProfessorStrategyDispatcher implements ProfessorStrategyDispatcher {
    ...
    @Override
    public List<InternshipAssignment> dispatch(ProfessorMatchingOptions strategy, List<InternshipAssignment> internshipAssignments) {
         return Optional.ofNullable(strategyMap.get(strategy))
                ...
                .filterProfessorCompatibleAssignments(internshipAssignments);
    }
}
