...
public class CompanyPositionController {
    ...
    public String handleCreateForm(
            @Valid @ModelAttribute("position") InternshipPositionCreateDto internshipPositionCreateDto,
            BindingResult bindingResult) {

        if (bindingResult.hasErrors())
            return "company/new_position";

        internshipPositionService.createPosition(internshipPositionCreateDto);
    ...
    public String handleEditForm(
            ...
            @Valid @ModelAttribute("position")InternshipPositionEditDto internshipPositionEditDto,
            BindingResult bindingResult) {

        if (bindingResult.hasErrors())
            return "company/edit_position";

        internshipPositionService.updatePosition(internshipPositionEditDto, id);
        return "redirect:/company/dashboard";
    }
}
